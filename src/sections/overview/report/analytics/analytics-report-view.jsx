    ...
    const fetchReports = useCallback(async () => {
      try {
        ...
        const response = await fetch(
          `${CONFIG.apiUrl}/Report/reports?accountId=${selectedAccount}&reportType=2&startDate=${startDate}&endDate=${endDate}`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
      ...
      <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.report.analytics.new}
              variant="contained"
                      ...
                      {dataFiltered
                        ...
                        .map((row) => (
                          <ReportTableRow
                            ...
                            detailsHref={paths.dashboard.report.analytics.view(row.id)}
                          />
                        ))}
