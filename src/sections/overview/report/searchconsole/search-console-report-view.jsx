...
export function SearchConsoleReportView() {
    ...
    const fetchReports = useCallback(async () => {
      try {
        ...
        const response = await fetch(
          `${CONFIG.apiUrl}/Report/reports?accountId=${selectedAccount}&reportType=3&startDate=${startDate}&endDate=${endDate}`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
      ...
      <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.report.search_console.new}
              variant="contained"
                      ...
                      {dataFiltered
                        ...
                        .map((row) => (
                          <ReportTableRow
                            ...
                            detailsHref={paths.dashboard.report.search_console.view(row.id)}
                          />
                        ))}
